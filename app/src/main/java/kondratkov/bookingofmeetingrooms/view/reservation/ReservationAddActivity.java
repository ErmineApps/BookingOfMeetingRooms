...
import kondratkov.bookingofmeetingrooms.view.datatimepicker.DateTimePickerFragment;
import kondratkov.bookingofmeetingrooms.view.datatimepicker.FragmentFactory;
...
public class ReservationAddActivity extends AppCompatActivity {
    ...
    private boolean request_add()throws Exception {
        ...
        String d = dataTimePepresentation.getDateToString(mLocalStartDateTime);
        String dd= dataTimePepresentation.getDateToString(mLocalEndDateTime);
